...
int main(int argc, char *argv[]) {
  ...
  std::cout << "--------------- SIMD with two loop ---------------\n";
  {
    ...
    double gather_cycles_per_tuple = static_cast<double>(gather_cycles) / static_cast<double>(kNumKeys * run_times);
    double hash_cycles_per_tuple = static_cast<double>(hash_cycles) / static_cast<double>(kNumKeys * run_times);
